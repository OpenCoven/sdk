...
const windowsBootstrapFixturePath = resolve(
  workspaceRoot,
  'tests/fixtures/chat-c1cc26-windows-bootstrap.ps1.br',
);
const protectedWorkflowFixturePath = resolve(
  workspaceRoot,
  'tests/fixtures/chat-c1cc26-client-v1-conformance.yml.br',
);
...
describe('unresolved SDK #38 conformance gaps', () => {
  ...
  test('freezes the compatible Chat schema-v2 producer and protected workflow', () => {
    ...
    expect(lock.evidenceProducer).toEqual({
      status: 'compatible',
      repository: 'OpenCoven/chat',
      commit: 'c1cc26a6bd180d182f767acdd4804ef0505ef233',
      tree: 'a757810ecb534f277bb3dfb7ac83fbd64f3fbfc6',
      packageManifest: {
        path: 'package.json',
        size: 4_044,
        sha256:
      ...
      harness: {
        ...
        size: 203_170,
        sha256:
          '9f0c12ab30939a77c3ecac5f86c932446871a28d9be5ad4609b17d2f65fc145f',
      },
      command: 'test:phase1-conformance',
      recordSchemaVersion: 2,
      workflow: {
        ...
        size: 465_045,
        sha256:
          '8f47ea4fb25594701312022bf6df04ce5465b78acd706e92f1ee64dbb4f091ca',
        job: 'platform-conformance',
        jobNameTemplate: 'platform-conformance ({platform})',
        aggregationJob: 'aggregate-conformance',
        aggregationJobName: 'aggregate-conformance',
        ...
        windowsBootstrapScriptSha256:
          '78557bb603b8e1a49eee090244874f654415a9e859742c69061ffb2cee4d2c7f',
        ...
        unixSupervisorPreparationScriptSha256:
          'a6106b7031af163ecf100b8ee611265b8c87e7da2710fb2fb31a7105904bc8cd',
        unixToolPathSource: {
          path: 'scripts/executable-resolution.mjs',
          size: 9_154,
          sha256:
        ...
        signerWorkflow:
          'OpenCoven/chat/.github/workflows/client-v1-conformance.yml',
        signerDigest: 'c1cc26a6bd180d182f767acdd4804ef0505ef233',
        sourceDigest: 'c1cc26a6bd180d182f767acdd4804ef0505ef233',
        predicateType: 'https://slsa.dev/provenance/v1',
        denySelfHostedRunners: true,
      },
    });
  ...
  test('requires full checkout history so the locked Chat harness revision is available', () => {
    ...
    expect(sha256(TEST_WINDOWS_CHILD_BOOTSTRAP)).toBe(
      '085c94c72ddd342ca112a63b51b1edfe2d2796ed490033702f7720bf7293358a',
    );
    expect(() =>
      verifyProtectedWorkflow(
