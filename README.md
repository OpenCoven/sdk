...
records remain historical evidence. This binding selects the merged [Chat #364](https://github.com/OpenCoven/chat/pull/364)
...
Production credentials require direct `@napi-rs/keyring` `2.1.0`; the CLI
