...
describe('unresolved SDK #38 conformance gaps', () => {
  ...
  test('freezes the exact candidate, manifest, package, source, and consumer bytes', () => {
    ...
    expect(lock.sources).toMatchObject({
      cave: {
        commit: 'cb3d22d1f403dd3b94b02668a599a2bf94999e8b',
        tree: '2d05861d243a3a5761c160765c011aa6dde6131f',
      },
      coven: {
  ...
  test('freezes the compatible Chat schema-v2 producer and protected workflow', () => {
    ...
    expect(lock.evidenceProducer).toEqual({
      status: 'compatible',
      repository: 'OpenCoven/chat',
      commit: 'df10699bb7e1cc792ac6e197fe99d8c355e2bf18',
      tree: '6eafdf142a903f49c15f33c2389696d3f8c76eed',
      packageManifest: {
        path: 'package.json',
        size: 4_044,
        sha256:
      ...
      harness: {
        ...
        size: 212618,
        sha256:
          '7a770074a35745627599a28e1752684661eb1403e2b3024db429e4c4700ebc67',
      },
      command: 'test:phase1-conformance',
      recordSchemaVersion: 2,
      workflow: {
        ...
        size: 511_602,
        sha256:
          '42f236d3ff80fe761ec21580830464e96ee43f918cd831382ee11be85765af2c',
        job: 'platform-conformance',
        jobNameTemplate: 'platform-conformance ({platform})',
        aggregationJob: 'aggregate-conformance',
        aggregationJobName: 'aggregate-conformance',
        ...
        windowsBootstrapScriptSha256:
          '686b9ee32df8597937968521a69a84abc83dd670a98476e7d369a38f5626d2a4',
        ...
        unixSupervisorPreparationScriptSha256:
          'f385888cbdfba67c3559527b7917cec95346eb36e7f087a79d715ddd0d141c87',
        unixToolPathSource: {
          path: 'scripts/executable-resolution.mjs',
          size: 9_154,
          sha256:
        ...
        signerWorkflow:
          'OpenCoven/chat/.github/workflows/client-v1-conformance.yml',
        signerDigest: 'df10699bb7e1cc792ac6e197fe99d8c355e2bf18',
        sourceDigest: 'df10699bb7e1cc792ac6e197fe99d8c355e2bf18',
        predicateType: 'https://slsa.dev/provenance/v1',
        denySelfHostedRunners: true,
      },
    });
  ...
  test('requires full checkout history so the locked Chat harness revision is available', () => {
    ...
    expect(sha256(TEST_WINDOWS_CHILD_BOOTSTRAP)).toBe(
      'a76ba8216c93e111f26476238e071fabc872cfc85822692b7bc79b2f23773e65',
    );
    expect(() =>
      verifyProtectedWorkflow(
  ...
  test('freezes the exact Windows supervisor diagnostics and quarantine contract', () => {
    ...
    expect(sha256(TEST_WINDOWS_SUPERVISOR_TEST)).toBe(
      'b6835ef6ebadec046086f8f36b5df518d6462e486c3b32a92bff027d316744ea',
    );
  ...
  test('runs the exact frozen Cave engine regression in CI', () => {
    ...
    expect(workflow).toContain(
      'ref: cb3d22d1f403dd3b94b02668a599a2bf94999e8b',
    );
