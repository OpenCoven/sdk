...
describe('Cave contract provenance', () => {
  ...
  test('pins the reviewed producer commit, path, and fixture digest', () => {
    ...
    expect(provenance).toEqual({
      ...
      sha256: '15be473203a68555ed69f267ff2b1d8dd0933d7eb1d3fe3f01246c25a8e61d38',
    });
  });
  ...
  test('proves an explicit authority checkout has the reviewed fixture bytes', () => {
    ...
    expect(
      verifyCaveContractAuthority({
        caveRoot,
        expectedCommit: 'e2b5b9d10d8498895ba9ff39ce6185f4ed873b57',
        resolveCommit: () => 'e2b5b9d10d8498895ba9ff39ce6185f4ed873b57',
      }),
    ).toEqual({
      commit: 'e2b5b9d10d8498895ba9ff39ce6185f4ed873b57',
      sha256: '15be473203a68555ed69f267ff2b1d8dd0933d7eb1d3fe3f01246c25a8e61d38',
  ...
  test('rejects an authority checkout at any other commit', () => {
    ...
    ).toThrowError(/expected e2b5b9d10d8498895ba9ff39ce6185f4ed873b57/u);
  });
});
