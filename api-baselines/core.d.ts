...
declare const CAVE_CAPABILITIES: readonly ["health", "pairing", "credentials", "familiars", "familiar-contract", "familiar-analytics", "projects", "conversations", "conversation-messages", "cursors"];
declare const CAVE_OPERATIONS: readonly ["health.read", "pairing.create", "pairing.poll", "pairing.exchange", "pairing.admin.list", "pairing.admin.decide", "credentials.admin.list", "credentials.admin.revoke", "familiars.list", "familiars.contract.read", "familiars.analytics.read", "projects.list", "conversations.list", "conversations.read", "messages.list"];
