...
describe('unresolved SDK #38 conformance gaps', () => {
  ...
  test('freezes the exact candidate, manifest, package, source, and consumer bytes', () => {
    ...
    expect(lock.candidate).toMatchObject({
      commit: '77d825d17809cfec2fad4acb9b1526b3c4752f9d',
      tree: '697764ae382ca56d6fde39b9929405d86e739d67',
      releaseManifest: {
    ...
    expect(lock.candidate.sdkPackages).toEqual([
      ...
      },
      {
        ...
        size: 42_960,
        sha256:
          'e2d4d27c05b51eb1eb5d34d15134b73d4e2c416d72c32de18ace9a908d51c14a',
      },
      {
    ...
    expect(lock.sources).toMatchObject({
      ...
      chat: {
        commit: '636f7da96fa178c2c14648f84137091b15a1cb8a',
        tree: '8e20adb1d55f17fb5b5a833bad6c9535d41c98ce',
        consumerLock: {
          path: 'pnpm-lock.yaml',
          size: 56_222,
          sha256:
            '5c9d0bd1d9438006970d9d7dc86186beb578c0eaff597f59a8277b94187d191d',
        },
      },
    });
    ...
    for (const expected of lock.candidate.cavePackageFiles) {
      const bytes = execFileSync(
        ...
        [
          ...
          workspaceRoot,
          'show',
          `77d825d17809cfec2fad4acb9b1526b3c4752f9d:${expected.path}`,
        ],
        { encoding: 'buffer' },
      );
  ...
  test('freezes the compatible Chat schema-v2 producer and protected workflow', () => {
    ...
    expect(lock.evidenceProducer).toEqual({
      status: 'compatible',
      repository: 'OpenCoven/chat',
      commit: '7ec15b20b5526ef809c8f237a4dab1f640cb8a4d',
      tree: '30bb409137aa108d12a5b4dfdef7d0940989771c',
      source: {
        repository: 'OpenCoven/chat',
        commit: 'be3b31ea5078e6f7d76973af9c3e3f92269334a5',
        tree: '30bb409137aa108d12a5b4dfdef7d0940989771c',
      },
      sourceAuthorityPath: [
        {
          repository: 'OpenCoven/chat',
          commit: 'c666f1488d6add9fad2c9936929201cf22dc38e9',
          tree: '60e3c0f88ef8d33d7c4b539931a9343f2c41f63b',
        },
        {
          repository: 'OpenCoven/chat',
          commit: '5d7567de951390f42c24b8e92ef55eb73bbe6040',
          tree: 'dc9f164d73a77a508df8a715e354b1cd8a288e01',
        },
      ],
      harnessAuthority: {
        repository: 'OpenCoven/chat',
        commit: '110b98b3ade90a10372efd433acdd9b5662369b4',
      ...
      packageManifest: {
        ...
        size: 4_044,
        sha256:
          '33a7ee0cebfa0e964873e3c6ab7352d6b129d10b860ce2cb2b13bc7845155e2b',
      },
      harness: {
        path: 'scripts/phase1-conformance.mjs',
        version: '2.0.0',
        size: 217978,
        sha256:
          '2d21af2960b0ac27f5af7c9cb70a84f7518593a1e3b7ec2f45e61bd0817ad100',
      },
      command: 'test:phase1-conformance',
      recordSchemaVersion: 2,
      workflow: {
        ...
        size: 167_062,
        sha256:
          '8fe64874da01038a5d4b1069974ae1d20afed61bffea40abe59065fd7aa2f939',
        job: 'platform-conformance',
        jobNameTemplate: 'platform-conformance ({platform})',
        aggregationJob: 'aggregate-conformance',
        aggregationJobName: 'aggregate-conformance',
        ...
        windowsBootstrapScriptSha256:
          '61a7f352224f15c8996d15d61ac7b2ce0c2092fd25ebd78ebdc01595360d0186',
        ...
        unixSupervisorPreparationScriptSha256:
          'e5b95eafed79d9d989b46e4f064a9537475332a8904f589c8c830a8e88aa57ef',
        unixToolPathSource: {
          path: 'scripts/executable-resolution.mjs',
          size: 9_154,
          sha256:
        ...
        signerWorkflow:
          'OpenCoven/chat/.github/workflows/client-v1-conformance.yml',
        signerDigest: '7ec15b20b5526ef809c8f237a4dab1f640cb8a4d',
        sourceDigest: '7ec15b20b5526ef809c8f237a4dab1f640cb8a4d',
        predicateType: 'https://slsa.dev/provenance/v1',
        denySelfHostedRunners: true,
      },
    });
  ...
  test('requires full checkout history so the locked Chat harness revision is available', () => {
    ...
    expect(sha256(TEST_WINDOWS_CHILD_BOOTSTRAP)).toBe(
      '27443e9c7bbc9bd2626a8e0c7c2923a189980bbcc616e05414a673e304742615',
    );
    expect(() =>
      verifyProtectedWorkflow(
  ...
  test('freezes every Cave assertion and the complete exclusion set', () => {
    ...
    expect(registry.provenance).toEqual({
      ...
      engine: {
        ...
        size: 150_592,
        sha256:
          '3e18320712aafb5208e5eddb66b1916208b5b208aec8a5d79a8d900c7909cc92',
      },
      includeTtl: true,
