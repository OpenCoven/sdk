...
const PREFLIGHT_JOB_SHA256 =
  '1d74a3cffa68e6438f5606b59107d0aaf707c83986fe4bfced938f30e3b5402a';
const REPOSITORY_VERIFICATION_JOB_SHA256 =
  '43bd16859c599d42f6083433f5865c353e060ad0467f6a6e2bf651187abdeaa3';
const PUBLICATION_CANDIDATE_JOB_SHA256 =
  'e0a3ca002943294dab0dabf3aee8425f8be9a51b6a80a791e7c4100bbc711bca';
...
const APPROVAL_WITNESS_ATTESTATION_JOB_SHA256 =
  '39e7b32b383839c1db7be4d614868a7a244216da29f41bab43150955c36dcf6f';
...
function validateConfigValues(config) {
  ...
  if (
    ...
    || config.conformanceEvidence.runtimeManifestSha256
      !== 'd1e6ba145534897b5a55b4d81511c5e797f245b436d84545f2418759d44a1121'
    || (
