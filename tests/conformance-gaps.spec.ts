...
const windowsBootstrapFixturePath = resolve(
  workspaceRoot,
  'tests/fixtures/chat-1f291a-windows-bootstrap.ps1.br',
);
const protectedWorkflowFixturePath = resolve(
  workspaceRoot,
  'tests/fixtures/chat-1f291a-client-v1-conformance.yml.br',
);
const unixSupervisorPreparationFixturePath = resolve(
  workspaceRoot,
  'tests/fixtures/chat-1f291a-unix-supervisor-preparation.sh.br',
);
...
describe('unresolved SDK #38 conformance gaps', () => {
  ...
  test('freezes the exact candidate, manifest, package, source, and consumer bytes', () => {
    ...
    expect(lock.sources).toMatchObject({
      cave: {
        commit: 'd20d83c46ba0c32433ce8dc6a358fb14b6bd0e45',
  ...
  test('freezes the compatible Chat schema-v2 producer and protected workflow', () => {
    ...
    expect(lock.evidenceProducer).toEqual({
      status: 'compatible',
      repository: 'OpenCoven/chat',
      commit: '3a4e003e12da02e7f0259da2aa6f831d85646166',
      tree: '5b1a37706e669711562713a259e3f8db4f01349d',
      packageManifest: {
        path: 'package.json',
        size: 4_044,
        sha256:
      ...
      harness: {
        ...
        size: 203_817,
        sha256:
          '42252f6f51cf8673f5771508f5b74b7c026203aa954f5a92d22b3027addbe100',
      },
      command: 'test:phase1-conformance',
      recordSchemaVersion: 2,
      workflow: {
        ...
        size: 465_045,
        sha256:
          '13adbc05ff760d6b29ff9cc0c270e4daea2f309e061fc3becb24add228d5dcd7',
        job: 'platform-conformance',
        jobNameTemplate: 'platform-conformance ({platform})',
        aggregationJob: 'aggregate-conformance',
        aggregationJobName: 'aggregate-conformance',
        ...
        windowsBootstrapScriptSha256:
          '746c7f129e406ad6f2eda82fdf1f92b9814e3443b2279644011c5c9d660d320e',
        ...
        unixSupervisorPreparationScriptSha256:
          '208224e180c74751033344e6148190f15712c31f373bf0f428feaebd1153aba9',
        unixToolPathSource: {
          path: 'scripts/executable-resolution.mjs',
          size: 9_154,
          sha256:
        ...
        signerWorkflow:
          'OpenCoven/chat/.github/workflows/client-v1-conformance.yml',
        signerDigest: '3a4e003e12da02e7f0259da2aa6f831d85646166',
        sourceDigest: '3a4e003e12da02e7f0259da2aa6f831d85646166',
        predicateType: 'https://slsa.dev/provenance/v1',
        denySelfHostedRunners: true,
      },
    });
  ...
  test('requires full checkout history so the locked Chat harness revision is available', () => {
    ...
    expect(sha256(TEST_WINDOWS_CHILD_BOOTSTRAP)).toBe(
      'b2650e687a88ebc833cd9081ad2bb96717e1a2dbe4edbc4ff4255bea743e2ef0',
    );
    expect(() =>
      verifyProtectedWorkflow(
  ...
  test('freezes every Cave assertion and the complete exclusion set', () => {
    ...
    expect(registry.provenance).toEqual({
      ...
      engine: {
        ...
        size: 146_472,
        sha256:
          'a3f16292f0200711c44553bb6874d64f19e94474ae7e9412127ac4c705b79f2c',
      },
      includeTtl: true,
  ...
  test('runs the exact frozen Cave engine regression in CI', () => {
    ...
    expect(workflow).toContain(
      'ref: d20d83c46ba0c32433ce8dc6a358fb14b6bd0e45',
    );
