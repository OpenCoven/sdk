...
function protectedProducerSteps(): string[] {
  return [
    ...
    '        run: \'node --input-type=module --eval "import { appendFileSync, readFileSync } from \'\'node:fs\'\'; const lock = JSON.parse(readFileSync(\'\'phase1-conformance.lock.json\'\', \'\'utf8\'\')); const output = process.env.GITHUB_OUTPUT; if (!output) throw new Error(\'\'GITHUB_OUTPUT must be set\'\'); for (const key of [\'\'sdk\'\', \'\'cave\'\', \'\'coven\'\', \'\'evidence\'\']) { appendFileSync(output, `${key}_repository=${lock[key].repository}\\n`); appendFileSync(output, `${key}_revision=${lock[key].revision}\\n`); }"\'',
    ...
    '          OPENCOVEN_SDK_ROOT: ${{ github.workspace }}/.cross-repo/sdk',
    '          OPENCOVEN_SDK_EVIDENCE_ROOT: ${{ github.workspace }}/.cross-repo/sdk-evidence',
    '          OPENCOVEN_SDK_VALIDATOR_ROOT: ${{ github.workspace }}/.cross-repo/sdk-validator',
    '          OPENCOVEN_CAVE_ROOT: ${{ github.workspace }}/.cross-repo/coven-cave',
    '          OPENCOVEN_COVEN_ROOT: ${{ github.workspace }}/.cross-repo/coven',
...
describe('unresolved SDK #38 conformance gaps', () => {
  ...
  test('freezes the compatible Chat schema-v2 producer and protected workflow', () => {
    ...
    expect(lock.evidenceProducer).toEqual({
      status: 'compatible',
      repository: 'OpenCoven/chat',
      commit: '8ac6f5d5868676bc9e8b7a15ee2f74fbe2ebd989',
      tree: '7b45a6e3a8cea38e7750510f998556f59b85d255',
      packageManifest: {
        path: 'package.json',
        size: 3_849,
        sha256:
      ...
      workflow: {
        ...
        size: 4_939,
        sha256:
          '678e59a1767b3f098c5a451b8d21b8600b7fe1c08d4d0874af193709c696ab26',
        job: 'platform-conformance',
        jobNameTemplate: 'platform-conformance ({platform})',
        aggregationJob: 'aggregate-conformance',
        aggregationJobName: 'aggregate-conformance',
        ...
        signerWorkflow:
          'OpenCoven/chat/.github/workflows/client-v1-conformance.yml',
        signerDigest: '8ac6f5d5868676bc9e8b7a15ee2f74fbe2ebd989',
        sourceDigest: '8ac6f5d5868676bc9e8b7a15ee2f74fbe2ebd989',
        predicateType: 'https://slsa.dev/provenance/v1',
        denySelfHostedRunners: true,
      },
    });
