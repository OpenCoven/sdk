...
const TEST_UNIX_TOOL_PATH_COMMAND = [
  ...
  'const nodeExecutable = resolveExecutableInvocation(\'node\',',
  'process.env, process.platform, []).resolvedCommand;',
  'const pnpmExecutable = resolveExecutableInvocation(\'pnpm\',',
  'process.env, process.platform, []).resolvedCommand;',
  'const rustupExecutable = resolveExecutableInvocation(\'rustup\',',
  'process.env, process.platform, []).resolvedCommand;',
...
describe('unresolved SDK #38 conformance gaps', () => {
  ...
  test('freezes the exact candidate, manifest, package, source, and consumer bytes', () => {
    ...
    expect(lock.candidate).toMatchObject({
      commit: '96804bc483a063e41e9a9738a4ace61970f6c0a4',
      tree: 'aa9eb8e924735419a9afdbcc80a5b087504ccc9d',
      releaseManifest: {
    ...
    expect(lock.candidate.sdkPackages).toEqual([
      {
        ...
        vendorPath: 'vendor/opencoven-sdk/sdk-core-0.0.1.tgz',
        size: 33_308,
        sha256:
      ...
      },
      {
        ...
        vendorPath: 'vendor/opencoven-sdk/cave-client-0.0.1.tgz',
        size: 83_218,
        sha256:
          'c4e44fb49a589ba26a2056f1308c31a7b86dec6d1e96506572e7a25b27b5fa0f',
      },
      {
        packageName: '@opencoven/coven-client',
        version: '0.0.1',
        releaseFile: 'tarballs/coven/opencoven-coven-client-0.0.1.tgz',
        vendorPath: 'vendor/opencoven-sdk/coven-client-0.0.1.tgz',
        size: 45_724,
        sha256:
          'bc24d3c1542ba7c970b8e5eb1e54d3d9e7acc3e07028466906947773a4b5ef65',
      },
      {
        packageName: '@opencoven/sdk',
        version: '0.0.1',
        releaseFile: 'tarballs/sdk/opencoven-sdk-0.0.1.tgz',
        vendorPath: 'vendor/opencoven-sdk/sdk-0.0.1.tgz',
        size: 16_025,
        sha256:
          '5318c4c6d511f0bcda42e4fd88168f549fc3ea74a516d7a4b2004e1c5023c4b4',
      },
    ]);
    expect(lock.candidate.cavePackageFiles).toEqual([
      ...
      },
      {
        ...
        size: 65,
        sha256:
          'e0c526d05cb0ba0fde6d3002fdf091b1686e9363656501bc57c5ece99d11af81',
      },
      {
        path: 'packages/cave/fixtures/contract-fixture.provenance.json',
        size: 333,
        sha256:
          'a2600544f609137df465c0350ee38e7ff56c2eb649556440714c2e0ba3b96010',
      },
      {
    ...
    expect(lock.sources).toMatchObject({
      ...
      coven: {
        ...
        tree: '163ea5b3fb89c741679dce0e121a2c1d9391472f',
      },
      chat: {
        commit: 'ef8c747f1dbae0fd2bc9fcb24d3a0914f9f1cc49',
        tree: 'ffd1963ef9539c7a679909200175fb11a9305c95',
        consumerLock: {
          path: 'pnpm-lock.yaml',
          size: 56_222,
          sha256:
            '62d871edd67d26cd4883814fc6146232ee0a5361675137cea257804344d0f555',
        },
      },
    });
    ...
    for (const expected of lock.candidate.cavePackageFiles) {
      const bytes = execFileSync(
        ...
        [
          ...
          workspaceRoot,
          'show',
          `96804bc483a063e41e9a9738a4ace61970f6c0a4:${expected.path}`,
        ],
        { encoding: 'buffer' },
      );
  ...
  test('freezes the compatible Chat schema-v2 producer and protected workflow', () => {
    ...
    expect(lock.evidenceProducer).toEqual({
      status: 'compatible',
      repository: 'OpenCoven/chat',
      commit: 'b10910545b14133a619e56641e5692a4335c83c4',
      tree: '7220622280415441646a3f6aef74113a98cc5bd2',
      source: {
        repository: 'OpenCoven/chat',
        commit: '27b41082d60f9acaaad2935e5a2b42005ee9e7fb',
        tree: '7220622280415441646a3f6aef74113a98cc5bd2',
      },
      sourceAuthorityPath: [],
      harnessAuthority: {
        repository: 'OpenCoven/chat',
        commit: '6a95b93d3eeb73a01f4a1882ea94ae9aa466345f',
        tree: 'fd814b80ae2dd7bf59429672d9758be2f438085c',
      },
      packageManifest: {
        path: 'package.json',
        size: 4_003,
        sha256:
          '179f39106eea9de00717331e094f7c20d542fc898973a18ab7777a0e69768609',
      },
      harness: {
        path: 'scripts/phase1-conformance.mjs',
        version: '2.0.0',
        size: 220183,
        sha256:
          '8f045e44cbe31377d7bb0697a398c27606c6505d2b3ff2ca23f8932809cb205c',
      },
      command: 'test:phase1-conformance',
      recordSchemaVersion: 2,
      workflow: {
        ...
        size: 181_684,
        sha256:
          'a06a8f82ce8a852e3020eb76629510fe07c24230338e5a06907f8c3905a94be3',
        job: 'platform-conformance',
        jobNameTemplate: 'platform-conformance ({platform})',
        aggregationJob: 'aggregate-conformance',
        aggregationJobName: 'aggregate-conformance',
        ...
        windowsBootstrapScriptSha256:
          '64e93e3a7ce03bf422b02eef80a96d6dc1b276b6847e41d5ad62b5a74ea42b3a',
        ...
        unixSupervisorPreparationScriptSha256:
          'ea36bc8d92dbcebcce5f50a7ab5b3f1ae0ef238af226ace907cae53f1c5ab668',
        unixToolPathSource: {
          path: 'scripts/executable-resolution.mjs',
          size: 9_154,
          sha256:
        ...
        unixValidationScriptSha256:
          '51d1402febcbcf9e5b117bdbc3ee2123a68d5ec6f560af5e629b727e7eb7b7bf',
        ...
        signerWorkflow:
          'OpenCoven/chat/.github/workflows/client-v1-conformance.yml',
        signerDigest: 'f4fbb423c811cc33ddbbc9a388933aa4089560df',
        sourceDigest: 'f4fbb423c811cc33ddbbc9a388933aa4089560df',
        sourceDescent: [
          'f4fbb423c811cc33ddbbc9a388933aa4089560df',
          '813ddde5f2478ac831da784e51cea61a0cb436b1',
          'e1d9c64391f4f8369d33f5178f73531ecde8530d',
          'cab1cace4cf8b38349794af069363936fa7269f1',
          'dbe11775eb63ab321f0bf2b925335397117b0180',
  ...
  test('requires full checkout history so the locked Chat harness revision is available', () => {
    ...
    const runBindings = [
      ['windowsBootstrapScriptSha256', 'platform-conformance', 'Bootstrap supervised Windows conformance'],
      ['validatorRevisionScriptSha256', 'platform-conformance', 'Require protected validator revision'],
      ['phase1RevisionsScriptSha256', 'platform-conformance', 'Read Phase 1 reviewed revisions'],
      ['linuxKeyringSetupScriptSha256', 'platform-conformance', 'Install Linux native dependencies'],
      ['unixSupervisorPreparationScriptSha256', 'platform-conformance', 'Prepare trusted Unix supervisor'],
      ['unixToolPathScriptSha256', 'platform-conformance', 'Compute reviewed Unix tool path'],
      ['unixProductionScriptSha256', 'platform-conformance', 'Run supervised Unix production and handoff'],
      ['unixValidationScriptSha256', 'platform-conformance', 'Validate broker-owned Unix platform record'],
      ['validationGuardScriptSha256', 'validate-conformance-artifacts', 'Require protected validator revision'],
      ['validationScriptSha256', 'validate-conformance-artifacts', 'Validate exact SDK schema, parser, and scanner'],
      ['attestationScriptSha256', 'attest-conformance-artifacts', 'Compare freshly downloaded artifact digests'],
    ] as const;
    for (const [field, job, name] of runBindings) {
      expect(workflowScriptSha256(TEST_PROTECTED_WORKFLOW_TEXT, job, name)).toBe(
        producer.workflow[field],
      );
    }
    ...
    expect(sha256(TEST_WINDOWS_CHILD_BOOTSTRAP)).toBe(
      '1559468e2ad680d5113df0de4c3017fd21eae401bc6a51fbe74e985283c5b313',
    );
    expect(() =>
      verifyProtectedWorkflow(
  ...
  test('freezes the exact Windows supervisor diagnostics and quarantine contract', () => {
    ...
    expect(sha256(TEST_WINDOWS_SUPERVISOR_TEST)).toBe(
      '0b9828c2cd801799bc0055fe4047e1e914ee7fcc921345dee6b0caa3a389386a',
    );
    const [exceptionChain, failureTrap] = TEST_WINDOWS_DIAGNOSTIC_TRAP.split('\n\ntrap {');
    expect(TEST_WINDOWS_SUPERVISOR_TEST).toContain(exceptionChain);
    expect(TEST_WINDOWS_SUPERVISOR_TEST).toContain(`trap {${failureTrap}`);
    expect(
      [
  ...
  test('authenticates downloaded GitHub records instead of committed aggregate claims', () => {
        ...
        workflow: TEST_PRODUCER_WORKFLOW_TEXT.replace(
          ...
          yamlLiteralRun(
            TEST_UNIX_SUPERVISOR_PREPARATION_COMMAND.replace(
              'b73036415744c80ed27d5667f255ceea149096ca517b47c93a154299802206ff',
              '0'.repeat(64),
            ),
          ),
        ),
    ...
    for (const variant of invalidWorkflowVariants) {
      ...
      >[1] = {
        ...producer,
        sourceAuthorityPath: [...producer.sourceAuthorityPath],
        workflow: {
          ...producer.workflow,
