...
archives byte-identical to candidate 96804bc. This binding selects the actual merged [Chat #297](https://github.com/OpenCoven/chat/pull/297)
...
The separate protected [run 35100084575](https://github.com/OpenCoven/chat/actions/runs/35100084575)
