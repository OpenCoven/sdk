// Entrypoint: .
// Declaration: dist/client-IsafYSlt.d.ts
...
interface CaveManagedCredentialTransport extends CaveTransport {
    ...
    managedHpkeFamiliarContract?(familiarId: string, discovered: Extract<CaveManagedDiscoveredEndpoint, {
        version: 2;
    }>, context?: OperationContext): Promise<CaveManagedHpkeResult>;
    managedHpkeFamiliarAnalytics?(familiarId: string, options: CaveFamiliarAnalyticsTransportOptions | undefined, discovered: Extract<CaveManagedDiscoveredEndpoint, {
        version: 2;
    }>, context?: OperationContext): Promise<CaveManagedHpkeResult>;
