// Entrypoint: .
// Declaration: dist/canonical-reads-BKthC-Oj.d.ts
 ...
 */
declare function canonicalFamiliarContractData(value: unknown): JsonObject;
/** The `data.analytics` record of a `familiars.analytics.read` envelope; see above. */
declare function canonicalFamiliarAnalyticsData(value: unknown): JsonObject;
